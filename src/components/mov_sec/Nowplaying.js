                ...
                <div className="flex items-center flex-wrap justify-center gap-5 py-10 px-6 w-[100%] h-auto ">
                    {
                        loader?(
                            ...
                            <>
                            {nowplaying.map((play) => (
                                <div className=' cursor-pointer bg-[#ffffff36] rounded-md shadow-xl  h-[250px] w-60 hover:transform hover:scale-110 hover:transition-transform duration-700  sm:h-[360px]' onClick={()=> handleclickMovieinfo(play)}>
                                    {/* movie poster */}
                                    {play.poster_path ? (
